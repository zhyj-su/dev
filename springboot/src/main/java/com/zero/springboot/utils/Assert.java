...
public abstract class Assert {
	 ...
	 * @param message the exception message to use if the assertion fails
	 * @throws ZeroException if the object is not {@code null}
	 */
	 ...
	 * @param object the object to check
	 * @param message the exception message to use if the assertion fails
	 * @throws ZeroException if the object is {@code null}
	 */
	...
	/**
	 * Assert that a String is not {@code blank}
	 * <pre class="code">Assert.notBlank(clazz,"The class must not be blank")</pre>
	 * @param str the String to check
	 * @param messsage the exception message to use if the assertion fails
	 * @throws ZeroException if the String is {@Code blank}
	 */
	public static void notBlank(@Nullable String str, String messsage){
		if(StringUtils.isEmpty(str)){
			throw new ZeroException(messsage);
		}
	}
	 ...
	 * @param message
	 */
	public static void equalToZero(Integer num,String message){
		if(num== 0){
			throw new ZeroException(message);
		}
	}
